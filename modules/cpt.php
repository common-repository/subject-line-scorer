...
$labels = array(
    'name' => __('Cards', $this->locale),
    'singular_name' => __('Card', $this->locale),
    'add_new' => __('Add New', $this->locale),
    'add_new_item' => __('Add New Card', $this->locale),
    'edit_item' => __('Edit Card', $this->locale),
    'new_item' => __('New Card', $this->locale),
    'all_items' => __('All Cards', $this->locale),
    'view_item' => __('View Card', $this->locale),
    'search_items' => __('Search Card', $this->locale),
    'not_found' =>  __('No Cards found', $this->locale),
    'not_found_in_trash' => __('No Cards found in Trash', $this->locale), 
    'parent_item_colon' => '',
    'menu_name' => __('Taro Cards', $this->locale)
...
$new_pt = new vooCPT( $args, 'taro_card' );
...
new vooTax( 'verse_cat', 'verse', $args );
